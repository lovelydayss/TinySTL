...
TEST_CASE(" test vector(const size_type count, const_reference value) ") {
	...
	// int
	m_vector<double>   mvec_i(size_t(20), 12);
...
TEST_CASE(" copy contruct and operator= ") {
	...
	// copy
	m_vector<int> mvec_i_5(size_t(1), 12);
	mvec_i_5 = mvec_i_3;
	...
	// move
	m_vector<int> mvec_i_6(size_t(1), 12);
...
TEST_CASE(" assign ") {
	...
	m_vector<int> mvec_i_1(size_t(1), 0);
	m_vector<int> mvec_i_2(size_t(1), 0);
	m_vector<int> mvec_i_3(size_t(1), 0);

	mvec_i_1.assign(size_t(5), 12);
